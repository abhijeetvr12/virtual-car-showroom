...
const product = {
  ...
  href: '#',
  breadcrumbs: [
    { id: 1, name: 'New Car', href: '#' },
    { id: 2, name: 'SUV', href: '#' },
  ],
  images: [
    {
      src: 'https://di-uploads-pod25.dealerinspire.com/royfosswoodbridge/uploads/2022/04/2023-Chevrolet-Corvette-models-and-trim-levels.jpg',
      alt: 'Two each of gray, white, and black shirts laying flat.',
    },
    {
      src: 'https://cars.usnews.com/static/images/Auto/izmo/i159615375/2023_chevrolet_corvette_stingray_dashboard.jpg',
      alt: 'Model wearing plain black basic tee.',
    },
    {
      src: 'https://di-uploads-pod33.dealerinspire.com/kearnymesachevy/uploads/2022/10/3-1024x408.png',
      alt: 'Model wearing plain gray basic tee.',
    },
    {
      src: 'https://dealerinspire-image-library-prod.s3.us-east-1.amazonaws.com/images/04b6KZwqt3tMjbQhyzpFkfkrQZTGQKbZ3wLM4rnz.jpg',
  ...
  sizes: [
    ...
    { name: '4 Seater', inStock: true },
    { name: '7 Seater', inStock: true },
  ...
  highlights: [
    ...
    'AVAILABLE 470 LB.-FT. OF TORQUE†',
    'AVAILABLE MAGNETIC SELECTIVE RIDE CONTROLTM 4.0'
  ],
  details:
...
export default function ProductDetails() {
  ...
  // console.log("brand",products.products?.discountedPrice)
  useEffect(()=>{
      ...
      <div className="pt-6">
        ...
        <div className="lg:col-span-1 maxt-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          <div className="lg:col-span-2 ">
            <h1 className="text-lg lg:text-xl font-semibold text-gray-900">{products.products?.brand}</h1>
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className='flex space-x-5 item-center text-lg lg:text-xl textgray900 mt-6'>
                <p className='font-semibold'>{products.products?.discountedPrice}Lakhs -</p>
                
        
                <p className='font-semibold'>{products.products?.price}Lakhs</p>
            ...
            <p className='opacity-50 text-sm '>124 ratings</p>
            <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>215 Reviews</p>
                            ...
                            <Grid item xs={5}>
                               ...
                               <div className='flex items-center space-x-3'>
                                <Rating name="read-only" value={4.6} precision={.5} readOnly />
                                 <p className='opacity-60'>92353 Ratings</p>
        ...
        <section className='pt-10'>
          ...
          <div className='flex flex-wrap space-y-5'>
            {mens_kurta.slice(0,4).map((item)=><HomeSectionCard product={item}/>)}
          </div>
        </section>
